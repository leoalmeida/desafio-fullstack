...
describe('NotificationService', () => {
  ...
  beforeEach(() => {
    ...
    const logSpy = jasmine.createSpyObj('LoggerService', ['log', 'error', 'warn']);
  ...
  it('deve apresentar um snackbar de informação quando show for chamado', () => {
    ...
    expect(loggerSpy.log).toHaveBeenCalledWith('Notificação ["INFO"]:', message);
  ...
  it('deve apresentar um snackbar de erro quando showError for chamado', () => {
    ...
    expect(loggerSpy.error).toHaveBeenCalledWith('Notificação ["ERRO"]:', message);
    expect(snackBarSpy.open).toHaveBeenCalledWith(
      message,
      'Close',
  ...
  it('deve apresentar um snackbar de aviso quando showWarning for chamado', () => {
    ...
    expect(loggerSpy.warn).toHaveBeenCalledWith('Notificação ["AVISO"]:', message);
    expect(snackBarSpy.open).toHaveBeenCalledWith(
      message,
      'Close',
  ...
  it('deve apresentar um snackbar de sucesso quando showSuccess for chamado', () => {
    ...
    expect(loggerSpy.log).toHaveBeenCalledWith('Notificação ["SUCESSO"]:', message);
    expect(snackBarSpy.open).toHaveBeenCalledWith(
      message,
      'Close',
