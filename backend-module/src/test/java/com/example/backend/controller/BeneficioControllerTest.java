...
public class BeneficioControllerTest {
    ...
    public void deveRetornarTodosBeneficios() throws Exception {
        ...
        response.andExpect(status().isOk())
                ...
                .andExpect(jsonPath(
                        "$[0].id", CoreMatchers.is(beneficioResponse1.getId().intValue())))
                .andExpect(jsonPath("$[0].nome", CoreMatchers.is(beneficioResponse1.getNome())))
                .andExpect(jsonPath(
                        "$[1].id",
                        CoreMatchers.is(beneficioResponseInativo.getId().intValue())))
                .andExpect(jsonPath("$[1].nome", CoreMatchers.is(beneficioResponseInativo.getNome())))
                .andExpect(jsonPath(
                        "$[2].id", CoreMatchers.is(beneficioResponse2.getId().intValue())))
    ...
    public void deveRetornarUmBeneficioAPartirDoId() throws Exception {
        ...
        ResultActions response =
                mockMvc.perform(get(TestFactory.BENEFICIOS_API_ENDPOINT + "/{id}", beneficioResponse1.getId()));

        // Verifica se o método do serviço foi chamado e se a resposta está correta
        response.andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath(
                        "$.id", CoreMatchers.is(beneficioResponse1.getId().intValue())))
                ...
                .andExpect(jsonPath(
                        "$.valor", CoreMatchers.is(beneficioResponse1.getValor().doubleValue())))
    ...
    public void deveAtivarBeneficioSolicitado() throws Exception {
        ...
        ResultActions response = mockMvc.perform(
                put(TestFactory.BENEFICIOS_API_ENDPOINT + "/{id}/{acao}", beneficioResponseInativo.getId(), "ativar"));
        // Verifica se o método do serviço foi chamado e se a resposta está correta
        response.andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath(
                        "$.id", CoreMatchers.is(beneficioResponseInativo.getId().intValue())))
                ...
                .andExpect(jsonPath(
                        "$.valor",
                        CoreMatchers.is(beneficioResponseInativo.getValor().doubleValue())))
        ...
        then(beneficioService).should(times(1)).alterarStatusBeneficio(beneficioResponseInativo.getId(), true);
    }
    ...
    public void deveCancelarBeneficioSolicitado() throws Exception {
        ...
        // Executa e verifica
        ResultActions response = mockMvc.perform(
                put(TestFactory.BENEFICIOS_API_ENDPOINT + "/{id}/{acao}", beneficioResponse2.getId(), "cancelar"));
        response.andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath(
                        "$.id", CoreMatchers.is(beneficioResponse2.getId().intValue())))
                ...
                .andExpect(jsonPath(
                        "$.valor", CoreMatchers.is(beneficioResponse2.getValor().doubleValue())))
                .andExpect(jsonPath("$.ativo", CoreMatchers.is(beneficioResponse2.getAtivo())));

        // Verifica se o método do serviço foi chamado com os parâmetros corretos
        then(beneficioService).should(times(1)).alterarStatusBeneficio(beneficioResponse2.getId(), false);
    }
    ...
    public void deveRetornarNovoBeneficioCriado() throws Exception {
        ...
        response.andDo(print())
                ...
                .andExpect(jsonPath("$.valor")
                        .value(CoreMatchers.is(beneficioResponse1.getValor().doubleValue())))
    ...
    public void deveAlterarBeneficioSolicitado() throws Exception {
        ...
        // Executa o teste para o comportamento esperado
        ResultActions response =
                mockMvc.perform(put(TestFactory.BENEFICIOS_API_ENDPOINT + "/{id}", beneficioResponse1.getId())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testRealizarTransferencia_Sucesso() throws Exception {
        ...
        // Executa e verifica
        ResultActions response = mockMvc.perform(post(TestFactory.BENEFICIOS_API_ENDPOINT + "/transferir")
